<template>
  <div class="golden">
    <el-form ref="elcrz" :model="elcrz" :inline="true" label-width="100px">
      <el-row>
        <el-col :span="7">
        ...
        <el-col :offset="1" :span="4">
          <el-form-item>
            <el-button type="primary" @click="checkform('elcrz')">查询</el-button>
            <el-button type="danger" @click="resetform('elcrz')">重置</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>

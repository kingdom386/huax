<template>
  <div class="golden">
    <el-form ref="elcrzds" :model="elcrzds" :inline="true" label-width="80px">
      <el-row>
        <el-col :span="6">
        ...
        <el-col :offset="1" :span="4">
          <el-form-item>
            <el-button type="primary" @click="checkform('elcrzds')">查询</el-button>
            <el-button type="danger" @click="resetform('elcrzds')">重置</el-button>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
